                      ...
                      child: SizedBox(
                        ...
                        child: InkWell(
                          ...
                          child: Stack(
                            ...
                            children: [
                              Image.asset("lib/assets/user.webp"),
                              listaTemImagem.contains((snapshot?.value
                                      as List)[int.parse(
                                          snapshot?.children.last.key ?? "0") -
                                      index]["username"])
                                  ? FadeInImage(
                        ...
                        Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              child: _maisDe2Linhas((snapshot?.value
                                      as List)[int.parse(
                                          snapshot?.children.last.key ?? "0") -
                                      index]["content"])
                                  ? Text(
                            ...
                            ? Padding(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: OpenContainer(
                                    ...
                                    openBuilder: (context, action) => Imagem(
                    ...
                    child: TextButton.icon(
                      ...
                      onPressed: () {
                        if (!(snapshot?.value as List)[
                            ...
                            .split(",")
                            .contains(username)) {
                          _like(int.parse(snapshot?.children.last.key ?? "0") -
                              index);
                        } else {
                          _unlike(
                              int.parse(snapshot?.children.last.key ?? "0") -
                      ...
                      icon: Icon(
                        ...
                        color: (snapshot?.value as List)[int.parse(
                                      snapshot?.children.last.key ?? "0",
                                    ) -
                                    index]["likes"]["users"]
                                .toString()
