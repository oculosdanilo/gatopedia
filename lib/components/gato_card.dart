...
class _GatoCardState extends State<GatoCard> {
  ...
  late final String gatoHash = widget.data
      .child("img")
      .value as String;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: OpenContainer(
        ...
        closedColor: username != null ? Theme
            .of(context)
            .colorScheme
            ...
            child: Row(
              ...
              children: [
                SizedBox(
                  width: 130,
                  height: 130,
                  child: FadeInImage(placeholder: BlurHashImage(gatoHash), image: CachedNetworkImageProvider()),
                ),
